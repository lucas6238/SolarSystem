function Moon(x,y,size,orbSpeed,orbDist) {
...
Moon.prototype.calcAccel = function(other){
   
}
Moon.prototype.pOrbit = function(other){
...
Moon.prototype.attract = function(other){
...
Moon.prototype.intersects = function(other) {
  ...
  Moon.prototype.turnAround = function(){
    this.velocity.mult(-1);
  }
  Moon.prototype.leaves =function(){
     if(this.position.x + this.radius < 0){
